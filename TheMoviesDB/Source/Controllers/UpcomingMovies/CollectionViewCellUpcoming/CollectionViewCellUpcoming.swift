//
//  CollectionViewCellUpcoming.swift
//  TheMoviesDB
//
...
class CollectionViewCellUpcoming: UICollectionViewCell {
    ...
    static let identifier = "CollectionViewCellUpcoming"
    ...
    func setupCell(movie: ResultUpComing?) {
